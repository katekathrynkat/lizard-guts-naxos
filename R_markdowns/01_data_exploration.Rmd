...
prey <- read_csv("output/00_prey.csv")

# Invertebrate counts by order from lizard stomach pumping samples
diet <- read_csv("output/00_diet_inverts.csv")

# Site by species matrix (invert prey data)
prey_matrix <- read_csv("output/00_prey_matrix.csv")

# Site by species matrix (diet data)
diet_matrix <- read_csv("output/00_diet_matrix.csv")
...
- Summed across trapping samples
...
- Summed across lizard diet samples
...
- Each dot is a trap
- Number of dimensions = `r ord$ndim`
